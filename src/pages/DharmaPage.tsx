...
export const DharmaPage: React.FC<DharmaPageProps> = ({
	...
	const renderContent = () => {
		...
		return (
			<div className="flex-1 flex flex-col w-full h-full">
				...
				<div className="flex-1 overflow-y-auto p-4 md:p-6 pb-[6rem]">
	...
	return (
		<main className="flex-1 flex flex-col overflow-hidden px-2 md:px-3 max-w-7xl mx-auto w-full bg-slate-100 dark:bg-gray-900 transition-colors">
